...
public class finalassignment1 {
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        double arearec=(Widthrec*Lengthrec);//multiplies the two to get the area and make it as a variable
        System.out.print("The area of the rectangle is ");//prints the area of the rectangle and leaves cursor on same line
        System.out.printf("%.2f", arearec);//print the area of the rectangle with 2 decimal places
        System.out.println("\nNow, I am going to calculate the area of a circle");//goes to new line and prints and moves cursor to next line
        ...
        double ac= (double) (radsquare* Math.PI);//Multiplies the radius squared times PI and saves it as a variable
        ...
        System.out.println("\nNow, I am going to calculate the Volume and the surface area of a cylinder");//moves to a new line,prints ,and moves cursor to next line
        ...
        double piradcylsquare=(float) (radcylsquare*Math.PI);//multiplies the radius^2 times pi
        double heightpiradcylsquare=(piradcylsquare*heightcyl);//multiplies the radius^2 times pi times height
        ...
        double sacyl=(piradcylsquaretwo+piradcylheight);//adds (pi*2*radius*height)with(radius^2 times pi*2)
        System.out.print("\nThe Surface area of the cylinder is ");//goes to a new line and prints
        System.out.printf("%.2f", sacyl);//prints the surface area to 2 decimals
        System.out.println("\nNow, I am going to calculate the time it takes for a pendulum to swing a distance ");//goes to new line and prints
        ...
        System.out.print("The time the pendulum takes to swing your distance in seconds is"+ " ");//prints
